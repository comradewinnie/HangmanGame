...
namespace HangmanGame
{
    public partial class GameForm : Form
    {
        ...
        private void CreateLetterButtons()
        {
            ...
            int startX = 285, startY = 255;
            int buttonSize = 50, padding = 3;
            ...
            for (int i = 0; i < alphabet.Length; i++)
            {
                Button btn = new Button
                {
                    ...
                    Width = buttonSize,
                    Height = buttonSize,
                    Location = new Point(startX + (buttonSize + padding) * (i % 13), startY + (buttonSize + padding) * (i / 13)),
                    Font = new Font("Showcard Gothic", 18, FontStyle.Regular),
                    Tag = alphabet[i]
                };
